...
- `Alpha for Mallows.R` — transformation of Mallows concentration parameters.
- `Pairwise Data Generation BT mechanism.R` — pairwise data generated and model fitting under the Bradley-Terry mechanism.
- `Pairwise Data Generation Thurstone mechanism.R` — pairwise data generated and model fitting under the Thurstone mechanism.
- `Complete Data Generation PL mechanism.R` — complete rankings generated and model fitting under the Plackett-Luce mechanism.
- `Complete Data Generation MM mechanism.R` — complete rankings generated under and model fitting the Mallows mechanism.
